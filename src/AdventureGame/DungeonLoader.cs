...
public static class DungeonLoader
{
    ...
    public static (Room[,] dungeon, DungeonMetadata metadata) Load(string filePath)
    {
        ...
        ValidateTraversableTile(dungeon, lampRow, lampCol, "lamp");
        ValidateTraversableTile(dungeon, keyRow, keyCol, "key");
        ValidateTraversableTile(dungeon, chestRow, chestCol, "chest");

        var metadata = new DungeonMetadata
        {
            ExitRow = exitRow,
            ExitCol = exitCol,
            GrueRow = grueRow,
